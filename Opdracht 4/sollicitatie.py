...
while True:
    try: 
        ...
        if vraag3 >= 90 and vraag3 <= 120:
            ...
            raise NameError('YOU ARE HUGE MY GUY!!')
        else:
...
if vraag4 == 'Y':
    ...
    if vraag4ervaring >= 4 and vraag4ervaring < 100:
        dressuurervaring = True
    elif vraag4ervaring == 100:
        raise NameError('unrealistic lol')
else:
...
if vraag5 == 'Y':
    ...
    if vraag5ervaring >= 5 and vraag5ervaring < 100:
        jonglerenervaring = True
    elif vraag5ervaring == 100:
        raise NameError('unrealistic lol')
else:
...
if vraag6 == 'Y':
    ...
    if vraag6ervaring > 3 and vraag6ervaring < 100:
        acrobatiekervaring = True
    elif vraag6ervaring == 100:
        raise NameError('unrealistic lol')
else:
